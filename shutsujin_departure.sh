...
EOF
    ...
    # agent inbox リセット
    for agent in shogun karo ashigaru{1..7} gunshi; do
...
PANE_LABELS=("karo" "ashigaru1" "ashigaru2" "ashigaru3" "ashigaru4" "ashigaru5" "ashigaru6" "ashigaru7" "gunshi")
...
# 色設定（karo: 赤, ashigaru: 青, gunshi: 黄）
